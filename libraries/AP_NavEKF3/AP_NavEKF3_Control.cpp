...
void NavEKF3_core::setAidingMode()
{
    ...
    if (PV_AidingMode != PV_AidingModePrev) {
        ...
        case AID_NONE:
            ...
            gcs().send_text(MAV_SEVERITY_WARNING, "[03402]EKF3 IMU%u stopped aiding",(unsigned)imu_index);
        ...
        case AID_ABSOLUTE:
            if (readyToUseGPS()) {
                ...
                posResetSource = GPS;
                velResetSource = GPS;
                gcs().send_text(MAV_SEVERITY_INFO, "[03600]EKF3 IMU%u is using GPS",(unsigned)imu_index);
